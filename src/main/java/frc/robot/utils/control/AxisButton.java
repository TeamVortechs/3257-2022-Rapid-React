...
public class AxisButton extends Button {
  ...
  public AxisButton(Joystick joystick, XboxJoystick.XboxAxis axis, double threshold, ThresholdType thresholdType) {
  ...
  public boolean get() {
    switch (this.thresholdType) {
      case EXACT:
        System.out.println("axis value: " + this.joy.getRawAxis(this.axis));
        return (this.joy.getRawAxis(this.axis) == this.targetVal);
      case LESS_THAN:
        return (this.joy.getRawAxis(this.axis) < this.targetVal);
      case GREATER_THAN:
        return (this.joy.getRawAxis(this.axis) > this.targetVal);
      case POV:
        return (this.joy.getPOV() == this.targetVal);
    } 
    return false;
  }
